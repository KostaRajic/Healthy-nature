const fruitsInfo = [
    ...
    },
    {
        ...
        text: 'Because fruits have been such a major part of the human diet, various cultures have developed many different uses for fruits they do not depend on for food. For example:' +
                ...
                'Many dry fruits are used as decorations or in dried flower arrangements. Ornamental trees and shrubs are often cultivated for their colorful fruits, including beautyberry, cotoneaster, holly, pyracantha, skimmia, and viburnum.' +
