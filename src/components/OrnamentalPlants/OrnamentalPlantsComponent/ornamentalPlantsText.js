export const ornamentalPlantsInfo = [
    {
        id: 1,
        topic: 'Ornamental plant',
        text: `Ornamental plants or garden plants are plants that are primarily grown for their beauty[1] but also for qualities such as scent or how they shape physical space. Many flowering plants and garden varieties tend to be specially bred cultivars that improve on the original species in qualities such as color, shape, scent, and long-lasting blooms. There are many examples of fine ornamental plants that can provide height, privacy, and beauty for any garden. These ornamental perennial plants have seeds that allow them to reproduce. One of the beauties of ornamental grasses is that they are very versatile and low maintenance.[2]
    ...
    },
    {
        id: 2,
        topic: 'History',
        text: `The cultivation of ornamental plants in gardening began in ancient civilizations around 2000 BC.[5] Ancient Egyptian tomb paintings of 1500 BC show physical evidence of ornamental horticulture and landscape design. The wealthy pharaohs of Amun had plenty of lands to grow all different kinds of ornamental plants.`
    },
    {
        id: 3,
        topic: 'Cultivation',
        text: `Ornamental plants and trees are distinguished from utilitarian and crop plants, such as those used for agriculture and vegetable crops, and for forestry or as fruit trees.[7] This does not preclude any particular type of plant being grown both for ornamental qualities in the garden, and for utilitarian purposes in other settings. Thus lavender is typically grown as an ornamental plant in gardens, but may also be grown as a crop plant for the production of lavender oil.[8]
    ...
    },
    {
        id: 4,
        topic: 'The term',
        text: `The term ornamental plant is used here in the same sense that it is generally used in the horticultural trades,[11][12] in which they are often just called "ornamentals". The term largely corresponds to 'garden plant', though the latter is much less precise, as any plant may be grown in a garden. Ornamental plants are plants that are grown for display purposes, rather than functional ones.[13] While some plants are both ornamental and functional, people usually use the term "ornamental plants" to refer to plants which have no value beyond being attractive, although many people feel that this is value enough. Ornamental plants are the keystone of ornamental gardening, and they come in a range of shapes, sizes, and colors suitable to a broad array of climates, landscapes, and gardening needs.
    ...
    },
    {
        ...
        text: `Ornamental grasses and grass-like plants are valued in home landscapes for their hardiness, ease of care, dramatic appearance, and a wide variety of colors, textures, and sizes available.[15] Many ornamental types of grass are true grasses (Poaceae), however, several other families of grass-like plants are typically marketed as ornamental grasses. These include the sedges (Cyperaceae), rushes (Juncaceae), restios (Restionaceae), and cat-tails (Typhaceae). All are monocotyledons, typically with narrow leaves and parallel veins. Most are herbaceous perennials, though many are evergreen and some develop woody tissues. Ornamental grasses are popular in many countries. They bring striking linear form, texture, color, motion, and sound to the garden, throughout the year.
                Ornamental grasses are popular in many colder hardiness zones for their resilience to cold temperatures and aesthetic value throughout the fall and winter seasons.`
    }
]