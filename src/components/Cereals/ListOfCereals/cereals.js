...
const cereals = [
  ...
  },
  {
    ...
    inGeneral: `Barley, scientifically known as *Hordeum vulgare*, is one of the oldest cultivated grains in the world, dating back over 10,000 years. It has long been valued for its versatility in cooking and its impressive nutritional profile. With its chewy texture and mild, nutty flavor, barley can be enjoyed in various forms, from whole grains to flour, and is used in soups, stews, salads, bread, and even beverages like beer and whiskey.  
    One of barley's standout features is its high fiber content, particularly beta-glucans, a soluble fiber known for its cholesterol-lowering properties. Regular consumption of barley can help improve heart health by reducing levels of LDL (bad) cholesterol, regulating blood pressure, and enhancing overall cardiovascular function. The fiber in barley also supports digestion by promoting regular bowel movements and nourishing beneficial gut bacteria, contributing to better gut health.  
    Barley is a good source of essential vitamins and minerals, including B vitamins such as niacin, thiamin, and riboflavin, which are important for energy metabolism and brain function. It also provides minerals like magnesium, manganese, selenium, and iron, which support bone health, antioxidant defense, and oxygen transport in the body.  
    Beyond its health benefits, barley has a low glycemic index, meaning it causes a slower, more gradual rise in blood sugar levels. This makes it an excellent grain for individuals managing diabetes or those looking to maintain stable energy levels throughout the day.  
    In culinary terms, barley is incredibly versatile. It can be used in soups and stews to add bulk and nutrition, served as a side dish similar to rice or quinoa, or even incorporated into baked goods for added texture and nutrients.  
    In summary, barley is an ancient grain with a wide range of health benefits. Its high fiber content, essential nutrients, and versatility in the kitchen make it a nutritious and delicious addition to any diet.`,
        topic1: "Nutrition and Health",
    nutritionText: [
      {
        element: "Energy value:",
